...
// ============================================================
// File Name: Chowdhury_LPM_32BitSignedAddSub_Dec7.v
// Megafunction Name(s):
// 			LPM_ADD_SUB
//
...
//lpm_add_sub DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=32 ONE_INPUT_IS_CONSTANT="NO" add_sub dataa datab overflow result
...
module  Chowdhury_LPM_32BitSignedAddSub_Dec7_add_sub
	( 
	add_sub,
	dataa,
	datab,
...
`endif
	...
	assign
		...
		overflow_wire = (((~ (dataa[31] ^ datab[31])) ^ (~ add_sub)) & (dataa[31] ^ wire_add_sub_cella_31sumout[0:0])),
...
endmodule //Chowdhury_LPM_32BitSignedAddSub_Dec7_add_sub
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module Chowdhury_LPM_32BitSignedAddSub_Dec7 (
	add_sub,
	dataa,
	datab,
	overflow,
	...
	Chowdhury_LPM_32BitSignedAddSub_Dec7_add_sub	Chowdhury_LPM_32BitSignedAddSub_Dec7_add_sub_component (
				.add_sub (add_sub),
				.dataa (dataa),
				.datab (datab),
				.overflow (sub_wire0),
