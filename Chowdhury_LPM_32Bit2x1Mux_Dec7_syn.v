...
// ============================================================
// File Name: Chowdhury_LPM_32Bit2x1Mux_Dec7.v
// Megafunction Name(s):
// 			LPM_MUX
//
...
module  Chowdhury_LPM_32Bit2x1Mux_Dec7_mux
	( 
	data,
	result,
...
`endif
	...
	assign
		...
		sel_wire = {sel[0]};
endmodule //Chowdhury_LPM_32Bit2x1Mux_Dec7_mux
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module Chowdhury_LPM_32Bit2x1Mux_Dec7 (
	data0x,
	data1x,
	sel,
	...
	wire [31:0] sub_wire5;
	wire [31:0] sub_wire2 = data0x[31:0];
	wire [31:0] sub_wire0 = data1x[31:0];
	wire [63:0] sub_wire1 = {sub_wire2, sub_wire0};
	wire  sub_wire3 = sel;
	wire  sub_wire4 = sub_wire3;
	wire [31:0] result = sub_wire5[31:0];

	Chowdhury_LPM_32Bit2x1Mux_Dec7_mux	Chowdhury_LPM_32Bit2x1Mux_Dec7_mux_component (
				.data (sub_wire1),
				.sel (sub_wire4),
				.result (sub_wire5));
