...
// ============================================================
// File Name: Chowdhury_LPM_32BitUnsignedComparator_Dec7.v
// Megafunction Name(s):
// 			LPM_COMPARE
//
...
//lpm_compare DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=32 aeb alb dataa datab
...
module  Chowdhury_LPM_32BitUnsignedComparator_Dec7_cmpr
	( 
	aeb,
	alb,
	dataa,
...
`endif
	...
	assign
		aeb = wire_aeb_int,
		alb = wire_alb_int;
endmodule //Chowdhury_LPM_32BitUnsignedComparator_Dec7_cmpr
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module Chowdhury_LPM_32BitUnsignedComparator_Dec7 (
	dataa,
	datab,
	aeb,
	...
	Chowdhury_LPM_32BitUnsignedComparator_Dec7_cmpr	Chowdhury_LPM_32BitUnsignedComparator_Dec7_cmpr_component (
				.dataa (dataa),
				.datab (datab),
				.aeb (sub_wire0),
				.alb (sub_wire1));
